const CACHE_NAME = 'yks2027-arena-20260824-02';
const APP_SHELL = [
  './',
  './index.html',
  './styles.css?v=20260824-02',
  './reports-v1.css?v=20260824-02',
  './engagement-v1.css?v=20260824-02',
  './app.js?v=20260824-02',
  './courses-v1.js?v=20260824-02',
  './engagement-v1.js?v=20260824-02',
  './manifest.webmanifest?v=20260824-02',
  './data/verified/mixed_core_v15_50.json?v=20260824-02',
