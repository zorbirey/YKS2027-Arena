...
function loadPlacementData(){if(!placementDataPromise){placementDataPromise=fetch('./data/placements-2025.json?v=20260824-07').then(function(response){if(!response.ok)throw new Error('Yerleştirme verisi yüklenemedi.');return response.json();});}return placementDataPromise;}
...
if('serviceWorker' in navigator){window.addEventListener('load',function(){navigator.serviceWorker.register('./sw.js?v=20260824-07').catch(function(){});});}
renderReports();
